	...
	<div id="wrap">
		<div class="total-container">
			<div class="title-container">
				...
				<h1>개인정보 관리</h1>
				<button onclick="tMyPageInfoUpdateOK()" id="btn-submit">저장</button>
				<button onclick="location.href='/tMyPageInfoDetail'" id="btn-cancel">취소</button>
			...
			<div class="main-container">
				...
				<div id="content">
					...
					<div id="student-status">
						<c:choose>
							<c:when test="${myPageInfo.status == 4}">재직
							</c:when>
							<c:when test="${myPageInfo.status == 5}">퇴직
							</c:when>
						</c:choose>
					</div>
		    ...
		    $.ajax({
		        ...
		        success: function(response) {
		            ...
		            if (response === "OK") {
		                ...
		                location.href = "/tMyPageInfoDetail";
		            } else {
