...
<body>
	<div id="wrap">
		...
		<div class="main-container">
			<!-- 엑셀 파일 업로드 폼 -->
			<div class="block">
				<form action="${pageContext.request.contextPath}/uploadTeacherExcel"
			...
			<!-- 일괄 등록 폼 -->
			<div class="block">
				<form action="${pageContext.request.contextPath}/saveTeacherData"
					method="post">
					...
					<c:forEach var="k" items="${TeacherList}" varStatus="v">
						...
						<input type="hidden" name="dept_name" value="${k.dept_name}" />
						<input type="hidden" name="t_dept_chair" value="${k.t_dept_chair}" />
					</c:forEach>
				</form>
