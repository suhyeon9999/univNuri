	...
	<div id="wrap">
		...
		<div class="main-container">
			<c:if test="${not empty successList}">
				<h2 class="list-title">등록 성공 교수 리스트</h2>
			...
			<div class="btn-group">
				<button onclick="location.href='/ateacherList'" class="btn-gray" id="student-list-btn">교수목록</button>
				<button onclick="location.href='/amoveInsertManyTeacher'"
