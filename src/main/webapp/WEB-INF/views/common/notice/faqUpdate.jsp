...
<!-- 					<li><a href="/loginTest">LOGIN_TEST</a></li> -->
		...
		<div class="container">
		<form action="/faqUpdate" method="post" name="faqForm" onsubmit="return validateForm()">
			<div class="form-group">
				<input type="text" class="line-input" name="title" required value="${detailFaq.title }" />
			<p class="meta">  작성일 : ${detailFaq.write_date.toString().substring(0, 10) }</p>
			</div>
			<hr />
			<div class="form-group">
